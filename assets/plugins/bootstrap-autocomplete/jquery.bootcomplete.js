...
(function ( $ ) {
    ...
    $.fn.bootcomplete = function(options) {
                ...
                xhr = $.ajax({
                    ...
                    success: function( json ) {
                        ...
                        $.each( json, function(i, j) {
                            results += '<a href="#" class="list-group-item" data-id="'+j.id+'" data-unidade="'+j.unidade+'" data-label="'+j.label+'">'+j.label+'</a>';
                        });
        ...
        function selectResult(){
            ...
            if($(this).data('unidade')!='undefined')
                $('#unidade').val($(this).data('unidade'));
            $(that).next('.' + settings.menuClass).hide();
            return false;
        }
