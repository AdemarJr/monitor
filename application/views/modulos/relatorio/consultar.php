<?php
if (!empty($filterRel)) extract($filterRel);
?>
<style>
    .card {
        border-radius: 15px;
...
<div class="block-header inline" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ol class="breadcrumb breadcrumb-bg- align-right">
            ...
            <li class="active">Mat&eacute;ria <?php  echo $this->uri->segment(1)?></li>
        </ol>
    </div>
    
    <?php if (empty($_SESSION['idClienteSessao'])) { ?>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="alert alert-warning">  <i class="material-icons">error</i> Selecione o cliente para a geração do relatório</div>
        </div>
    <?php } ?>
</div>
                    ...
                    <div class="col-xs-12 col-md-3 col-xl-3">
                        <div class="form-group form-float">
                            ...
                            <input type="text" class="datepicker form-control" id='horair' name='horair' placeholder="selecione a hora inicio..." value='<?php if (!empty($horair)) echo $horair; ?>'>
                                <label id="label-for" class="form-label">Hora Inicio</label>
                            </div>    
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-3 col-xl-3">
...
<!--                    <div class="col-xs-12 col-md-4 col-xl-4">
                ...
                <div class="row clearfix">
                    <div class="col-xs-12 col-md-3 col-xl-3">
                        <div class="form-group form-float">
                            <div class="form-line">
                                <select id="tipoMat" class="form-control show-tick"  name="tipoMat[]" title="Selecione o Tipo de Midía" data-live-search="true" multiple>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-xs-12 col-md-3 col-xl-3">
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type='text' class='form-control tag-rela' data-role="tagsinput" id='texto' placeholder="Tags" name='texto' value="<?php if (!empty($texto)) echo $texto;?>"/>
                                <label id="label-for" class="form-label"></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-3 col-xl-3">
                        <div class="form-group form-float">
                            <div class="form-line">
                                <select id="setor" class="form-control show-tick"  name="setor[]" title="Selecione o Secretaria" data-live-search="true" multiple>
                ...
                <div class="row clearfix">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <select id="opcRelatorio" class="form-control show-tick"  name="opcRelatorio">
                                    ...
                                    <option
                                        <?php if((!empty($opcRelatorio) and $opcRelatorio=='alertaFileTextExp') or empty($opcRelatorio)) echo ''; ?>
                                        value="alertaFileTextExp">Tipo Alerta em Arquivo - Em Testes</option>
                                    <option
                    ...
                    <div class="col-xs-12 col-md-3 col-xl-3">
                        <?php if (empty($_SESSION['idClienteSessao'])) { ?>
                        <button type="submit" disabled class="btn bg-red btn-circle-lg waves-effect waves-circle waves-float" data-toggle="tooltip" data-placement="top" title="Executar">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="display:none">
        <div class="card">
            <div class="header">Relatório de Inserção de Matérias</div>
            <div class="body">
                <?php echo form_open(base_url('dev/gerarelatorioinsercao'), array('role' => 'form', 'id' => 'formPadrao3', 'class' => 'Formulario3')); ?>
                <input type='hidden' id='op' name='acao'/>
                <div class="row">
                    <div class="col-xs-12 col-md-3 col-xl-3">
                        <div class="form-group form-float">
                            <div class="form-line">
                    ...
                    <div class="col-xs-12 col-md-3 col-xl-3">
                        <div class="form-group form-float">
                            <div class="form-line">
                                <select id="setor" class="form-control show-tick"  name="setor" title="Selecione o Setor" data-live-search="true">
                                    
                                    <?php if (!empty($lista_setor)) {
                                        foreach ($lista_setor as $item):
                                            ?>
                                            <?php if ($item['SEQ_SETOR'] == 723) { ?>    
                                            <option
                                                <?php if (!empty($setor) and $setor == $item['SEQ_SETOR']) echo 'selected'; ?>
                                                value="<?php echo $item['SEQ_SETOR'] ?>"><?php echo $item['SIG_SETOR'] . ' - ' . $item['DESC_SETOR']; ?></option>
                                            <?php } ?>
                    ...
                    <div class="col-xs-12 col-md-3 col-xl-3">
                        <div class="form-group form-float">
                            <div class="form-line">
                                <select id="tipo" class="form-control show-tick"  name="area" title="Selecione a &Aacute;rea" data-live-search="true">
                                    <option value="">Todos as &Aacute;reas</option>
                                    <?php if (!empty($lista_tipo)) {
                                        foreach ($lista_tipo as $item):
                                            ?>
                    ...
                    <div class="col-xs-12 col-md-12 col-xl-12">
                        <button type="submit" onclick="$('#op').val('pdf');" class="btn bg-red btn-circle-lg waves-effect waves-circle waves-float" data-toggle="tooltip" data-placement="top" title="Gerar">
                            <i class="material-icons">picture_as_pdf</i>
                        </button>
                         <button type="submit" onclick="$('#op').val('xls');" class="btn bg-red btn-circle-lg waves-effect waves-circle waves-float" data-toggle="tooltip" data-placement="top" title="Excel">
            ...
            <div class="body">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-2 col-xl-2">
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type="text" class="datepicker form-control" id='dataInicio2' name='datainicio' placeholder="Data de Inicio" required="">
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-2 col-xl-2">
...
<script>
    $(document).ready(function () {
        ...
        $('#dataInicio2').bootstrapMaterialDatePicker({
            format: 'DD/MM/YYYY',
            clearButton: true,
            weekStart: 1,
            lang: 'pt-br',
