        ...
        <div class="card">
            ...
            <div class="body">
                <div class="row clearfix nopadding">
                    <?php echo form_open(base_url('relatorio/processaLinkMateria'),array('role' => 'form', 'id' => 'formPadrao','class'=>'Formulario')); ?>
                    ...
                    <div class="col-xs-12 col-md-3 col-xl-3">
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                multiple
                                name="tipo[]" title="Selecione o Tipo da Materia" data-live-search="true">
                                    <option value="I" selected>Impresso</option>
                                    <option value="R" selected>R&aacute;dio</option>
                                    <option value="T" selected>Televis&atilde;o</option>
