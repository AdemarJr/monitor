<div class="block-header inline" xmlns="http://www.w3.org/1999/html">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h2><i class="material-icons">fiber_new</i> Contagem por &Aacute;rea da Mat&eacute;ria</h2>
        <small>Consulta de &Aacute;rea da Mat&eacute;ria.</small>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ol class="breadcrumb breadcrumb-bg- align-right">
            ...
            <li class="active">Contagem por &Aacute;rea da Mat&eacute;ria</li>
        </ol>
    </div>
</div>
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <?php echo form_open(base_url('relatorio/processaArea'),array('role' => 'form', 'id' => 'formPadrao','class'=>'Formulario')); ?>
                    <div class="row clearfix nopadding">
                        ...
                        <div class="col-xs-12 col-md-3 col-xl-3 hidden-print">
                            <button type="submit" onclick="$('#acao').val('pdf');" class="btn bg-red btn-circle-lg waves-effect waves-circle waves-float" data-toggle="tooltip" data-placement="top" title="Gerar Relat&oacute;rio">
...
<script type="text/javascript">
    $(function () {
        $('#formPadrao').validate({
            ...
            messages:{
                'datae': {
                    required: 'Data In&iacute;cio do Envio é Obrigatório'
                },
                'dataef': {
                    required: 'Data Fim do Envio é Obrigatório'
                },
                'datai': {
                    required: 'Data In&iacute;cio da Publica&ccedil;&atilde;o é Obrigatório'
                },
                'dataf': {
                    required: 'Data Fim da Publica&ccedil;&atilde;o é Obrigatório'
                }
            },
