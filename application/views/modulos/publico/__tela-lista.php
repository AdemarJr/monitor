                                            ...
                                            if (count($anexos) > 0) {
                                                foreach ($anexos as $itemA):
                                                    ?>
                                                        <p class="text-center">
                                                            <div class="up_images">
                                                                <a href="<?php echo base_url('publico/imagem2/').$itemA['SEQ_MATERIA'].'/'.$itemA['NOME_BIN_ARQUIVO'] ?>">
                                                                    <img class="img-responsive" src="<?php echo base_url('publico/imagem2/'.$itemA['SEQ_MATERIA'].'/'.$itemA['NOME_BIN_ARQUIVO']); ?>"/>
                                                                </a>
															</div>
                                                        </p>
                                                    <?php
