                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                        <div class="card ">
                                ...
                                <div class="row clearfix">
                                        ...
                                        <?php $flagModelo = empty($item['IND_MODELO'])? 'N':$item['IND_MODELO'];
                                            if($this->session->userData('idClienteSessaoAlerta') !=3 
                                                ...
                                                and $item['SEQ_CLIENTE']!=64
                                                    ...
                                                    echo '<br/>'.$item['DESC_SETOR'].' - '.$item['SIG_SETOR']; 
                                            ?>
                                    ...
                                    <div  class="col-xs-3 col-md-3 col-xl-3">
                                        <?php if (isset($_SESSION['perfilUsuario'])) { ?>
                                                <a href="<?= 'https://porto.am/monitor/materia/editar/'.$item['SEQ_MATERIA'] ?>"  data-tooltip="Editar Matéria" class="waves-effect waves-light btn-small right blue darken-1 tooltipped" style="width: 50px;margin-right: 1%;" target="_blank" ><i class="material-icons left">edit</i></a>
                                             <?php } ?>
                            ...
                            <div class="body nopadding">
                                <div class="panel-body ">
                                    <h4 class="col-blue-grey"><?php echo $item['TIT_MATERIA']; ?>
                                            ...
                                            if (count($anexos) > 0) {
                                                foreach ($anexos as $itemA):
                                                    ?>
														...
														<p class="text-justify"><?php echo nl2br($item['TEXTO_MATERIA']); ?></p>
                                                    <?php
                                                endforeach;
                                            }
                                         } else if ( $idCliente ==39 ) {
                                            $anexos = $this->ComumModelo->listaAnexo($item['SEQ_MATERIA']);
                                            if (count($anexos) > 0) {
                                                foreach ($anexos as $itemA):
                                                    ?>
                                    ...
                                    if ($item['TIPO_MATERIA'] == 'I') {
                                        ...
                                        if (count($anexos) > 0) {
                                            foreach ($anexos as $itemA):
                                                ...
                                                <audio id="audioMusica" controls preload="auto">
                                                    <source src="<?php echo base_url('publico/audio/') . $itemA['SEQ_ANEXO'] ?>" type="audio/mpeg">
                                                </audio>
                                                    <br/>
