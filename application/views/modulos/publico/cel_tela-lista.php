...
<div class="row clearfix" id="materia-data">
            ...
            if (!empty($lista_dias)) {
                foreach ($lista_dias as $item):
                    ...
                    ?>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 height-print">
                        <div class="card height-print-no">
                            <div class="header nopadding-print hidden-print">
                                ...
                                <div class="row clearfix">
                                    <button class="btn btn-primary waves-effect btn_analise" data-caixa="collapseTwo_<?php echo $item['SEQ_MATERIA'];?>"><i class="material-icons">perm_contact_calendar</i>An&aacute;lise do Conte&uacute;do</button>
                                ...
                                <?php } else if (!empty($item['RESUMO_MATERIA']) and !empty($item['RESPOSTA_MATERIA'])) { ?>
                                    <div class="row clearfix">
                                        <button class="btn btn-primary waves-effect collapse btn_analise" data-caixa="collapseTwo_<?php echo $item['SEQ_MATERIA'];?>"><i class="material-icons">perm_contact_calendar</i>An&aacute;lise do Conte&uacute;do</button>
                                        <div style="display: none" class="panel-group" id="accordion_<?php echo $item['SEQ_MATERIA'];?>">
                                            <div class="panel panel-col-cyan">
                            ...
                            <div class="body nopadding nopadding-print" style=" padding-bottom: 5px !important;">
                                ...
                                <div class="panel-body hidden-print <?php if($item['TIPO_MATERIA']=='I') echo 'nopadding'; ?> ajax-materia card-block"
