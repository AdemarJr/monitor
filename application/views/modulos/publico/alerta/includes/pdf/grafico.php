                ...
                <div class="section">
                    <div class="row">
                        <div class="col m6 s12">
                            <button class="btn black darken-5" style="height: 30px; border-radius: 15px; width: 100%; cursor: default;">
                                <p class="black-text center white-text" style="margin-top: 0px; text-transform: uppercase"><b>DISTRIBUIÇÃO POR PAÍS</b></p>
                            </button>
                            <div>
                                <canvas id="dist-pais"></canvas>
                            </div>
                        </div>
                        <div class="col m6 s12">
                            <button class="btn black darken-5" style="height: 30px; border-radius: 15px; width: 100%; cursor: default;">
                                <p class="black-text center white-text" style="margin-top: 0px; text-transform: uppercase"><b>DISTRIBUIÇÃO POR CIDADE</p>
                            </button>
                            <div>
                                <canvas id="dist-estado"></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 2%">
                        <div class="col m6 s12">
                            <button class="btn black darken-5" style="height: 30px; border-radius: 15px; width: 100%; cursor: default;">
                                <p class="black-text center white-text" style="margin-top: 0px; text-transform: uppercase"><b>DISTRIBUIÇÃO POR TIPO DE VEÍCULO</b></p>
                            </button>
                            <div>
                                <canvas id="dist-veiculo"></canvas>
                            </div>
                        </div>
                        <div class="col m6 s12">
                            <button class="btn black darken-5" style="height: 30px; border-radius: 15px; width: 100%; cursor: default;">
                                <p class="black-text center white-text" style="margin-top: 0px; text-transform: uppercase"><b>DISTRIBUIÇÃO POR VALOR (R$) TIPO DE VEÍCULO</p>
                            </button>
                            <div>
                                <canvas id="dist-veiculo-valor"></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 2%">
                        <div class="col m12 s12">
                            <button class="btn black darken-5" style="height: 30px; border-radius: 15px; width: 100%; cursor: default;">
                                <p class="black-text center white-text" style="margin-top: 0px; text-transform: uppercase"><b>DISTRIBUIÇÃO POR AVALIAÇÃO</b></p>
                            </button>
                            <div>
                                <canvas id="dist-avaliacao" width="550" height="550"></canvas>
                            </div>
                        </div>
