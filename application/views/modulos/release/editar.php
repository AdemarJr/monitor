...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
        ...
        <div class="body">
            <?php echo form_open(base_url('release/alterar'),array('role' => 'form', 'id' => 'formPadrao','class'=>'Formulario')); ?>
            <div class="masked-input">
                <div class="row clearfix">
                        <div class="col-xs-12 col-md-12 col-xl-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type='hidden'id='idRelease' name='idRelease' value='<?php if (!empty($idRelease)) echo $idRelease;?>'/>
                                    <textarea rows="4" class="form-control no-resize auto-growth" maxlength="500" id='descricaoRelease' name='descricaoRelease'><?php if (!empty($descricaoRelease)) echo $descricaoRelease;?></textarea>
                        ...
                        <div class="form-group form-float">
                          ...
                          <div class="col-xs-12 col-md-12 col-xl-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <select class="form-control show-tick"
                                            name="secretarias[]" multiple=""
                                            id="setor" data-live-search="true" data-size="5">
                                        <option value="">Outras Secretarias</option>
                                        <?php if (!empty($lista_setor)) {
                                            foreach ($lista_setor as $item): 
                                                $sec = $ctrl->getSetorPorID($item['SEQ_SETOR'], $idRelease);
                                                ?>
                                                <option
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#formPadrao').validate({
            ...
            messages:{
                'descricaoRelease': {
                    required: 'Descrição do Release é Obrigatório'
                },
                'dataEnvio': {
                    required: 'Data do Envio do Release é obrigatóriio!'
                },
                'setor': {
                    required: 'Setor do Release é obrigatóriio!'
                },
                'titulo': {
