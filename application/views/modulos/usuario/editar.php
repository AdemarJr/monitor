            ...
            <div class="row clearfix">
                ...
                <div class="body">
                    <?php //if (!empty($perfilUsuario) and $perfilUsuario!='ROLE_CLI') 
                        echo form_open(base_url('usuario/alterar'),
                    ...
                    <div class="masked-input">
                        <div class="row clearfix">
                            <div class="col-xs-12 col-md-8 col-xl-8">
                                ...
                                <div class="col-xs-12 col-md-6 col-xl-6">
                                    <div class="form-group form-float">
                                        <div class="form-line focused">
                                            <input type='hidden' id='cpfUsuario' name='cpfUsuario' value="<?php if (!empty($cpfUsuario)) echo $cpfUsuario;?>"/>
                                ...
                                <div class="col-xs-12 col-md-6 col-xl-6">
                                    <div class="form-group form-float">
                                        <div class="form-line focused">
                                            ...
                                            <input type='text' class='form-control' name='loginUsuario' id='loginUsuario' value="<?php if (!empty($loginUsuario)) echo $loginUsuario;?>">
                                ...
                                <div class="col-xs-12 col-md-6 col-xl-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select class="form-control" onfocus="$(this).parent().addClass('focused');"  name="perfilUsuario" id="perfilUsuario" required>
                                                <option value="">-- Selecione o Perfil --</option>
                                                <?php if (!empty($perfilUsuario) and $perfilUsuario=='ROLE_ADM') { ?>
                                                <option value="ROLE_ADM" <?php if (!empty($perfilUsuario) and $perfilUsuario=='ROLE_ADM') echo 'selected';?>>Administrador</option>
                                                <?php } ?>
                                                <option value="ROLE_USU" <?php if (!empty($perfilUsuario) and $perfilUsuario=='ROLE_USU') echo 'selected';?>>Usuário</option>
                                                <option value="ROLE_CLI" <?php if (!empty($perfilUsuario) and $perfilUsuario=='ROLE_CLI') echo 'selected';?>>Cliente</option>
                                                <option value="ROLE_REP" <?php if (!empty($perfilUsuario) and $perfilUsuario=='ROLE_REP') echo 'selected';?>>Representante</option>
                                                <option value="ROLE_SET" <?php if (!empty($perfilUsuario) and $perfilUsuario=='ROLE_SET') echo 'selected';?>>Usu&aacute;rio de Setor</option>
                                            </select>
                        ...
                        <div class="row clearfix">
                            <div class="col-xs-12 col-md-8 col-xl-8" id="div-clientes">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <select id="clientes" class="form-control show-tick" multiple="multiple" name="cliente[]" title="Selecione os clientes">
                                            <?php if (!empty($lista_cliente)) {
                                                foreach ($lista_cliente as $item): ?>
                                                    <option <?php if (!empty($cliente) and in_array($item['SEQ_CLIENTE'],explode(',',$cliente))) echo 'selected';?>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <select id="tipo" class="form-control show-tick" multiple="multiple" name="tipo[]" title="Selecione os Tipos de matérias">
                                            <option <?php if (!empty($tipo) and in_array('S',explode(',',$tipo))) echo 'selected';?> value="S">Internet</option>
                                            <option <?php if (!empty($tipo) and in_array('I',explode(',',$tipo))) echo 'selected';?> value="I">Impresso</option>
                                            <option <?php if (!empty($tipo) and in_array('R',explode(',',$tipo))) echo 'selected';?> value="R">R&aacute;dio</option>
                                            <option <?php if (!empty($tipo) and in_array('T',explode(',',$tipo))) echo 'selected';?> value="T">Televis&atilde;o</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
