    ...
    <div class="card">
        <div class="header">
            <div class="row clearfix">
                ...
                <div class="body">
                    <?php echo form_open(base_url('veiculo/alterarTv'),array('role' => 'form', 'id' => 'formPadrao','class'=>'Formulario')); ?>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12 col-xl-12">
                            <a href="<?php echo base_url('veiculo/consultat') ?>" class="btn bg-red btn-circle-lg waves-effect waves-circle waves-float" data-toggle="tooltip" data-placement="top" title="Cancelar">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#formPadrao').validate({
            ...
            messages:{
                'nomeVeiculo': {
                    required: 'Nome da Televisão é obrigatóriio!'
                },
