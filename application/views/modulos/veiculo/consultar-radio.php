<div class="block-header inline">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h2><i class="material-icons">fiber_new</i> Veículo-R&aacute;dio</h2>
        <small>Cadastro e Alteração de R&aacute;dios.</small>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ol class="breadcrumb breadcrumb-bg- align-right">
            ...
            <li class="active">Veículo-R&aacute;dio</li>
        </ol>
    </div>
</div>
<!-- Main content -->
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
        ...
        <div class="body">
            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                ...
                <?php if (!empty($lista_veiculo)) {
                    foreach ($lista_veiculo as $item): ?>
                        <tr>
                            <td><?php echo $item['NOME_RADIO'] ?></td>
                            <td><?php echo $item['CIDADE_RADIO'] ?></td>
                            <td><?php echo $item['SITE_RADIO'] ?></td>
                            <td data-title="Ação">
                                <div class='avoid-this action-buttons'>
                                    <?php if ($this->auth->CheckMenu('geral', 'veiculo', 'editarRadio') == 1) { ?>
                                        <a data-toggle="tooltip" data-placement="top" title="Editar" class='btn bg-blue btn-circle waves-effect waves-circle waves-float'
                                           href="<?php echo base_url('veiculo/editarRadio/') . $item['SEQ_RADIO'] ?>">
                                    ...
                                    if (($this->auth->CheckMenu('geral', 'veiculo', 'excluirRadio') == 1)) { ?>
                                        <a data-toggle="tooltip" data-placement="top" title="Excluir" class='btn bg-light-blue btn-circle waves-effect waves-circle waves-float botao-excluir'
                                           href="<?php echo base_url('veiculo/excluirRadio/') . $item['SEQ_RADIO'] ?>">
                                    ...
                                    if (($this->auth->CheckMenu('geral', 'veiculo', 'excluirRadio') == 1)) { ?>
                                        <a data-toggle="tooltip" data-placement="top"
                                           ...
                                           href="<?php echo base_url('veiculo/consultaPreco/R/') . $item['SEQ_RADIO'] ?>">
            ...
            <a href="<?php echo base_url('veiculo/consultar') ?>" class="btn bg-red btn-circle-lg waves-effect waves-circle waves-float" data-toggle="tooltip" data-placement="top" title="Atualizar esta tela">
                <i class="material-icons">refresh</i>
            </a>
            <a href="<?php echo base_url('veiculo/novo/r') ?>" class="btn bg-red btn-circle-lg waves-effect waves-circle waves-float" data-toggle="tooltip" data-placement="top" title="Novo Veículo">
