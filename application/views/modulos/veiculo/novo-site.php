    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ol class="breadcrumb breadcrumb-bg- align-right">
            ...
            <li><a href="<?php echo base_url('veiculo/consultas') ?>" class="ajax-link-interno">
                    <i class="material-icons">fiber_new</i>Site</a></li>
        ...
        <div class="header">
            <div class="row clearfix">
                <div class="col-xs-12 col-md-8 col-xl-8">
                    <h3 class="box-title">Dados do Site</h3>
                </div>
                ...
                <div class="body">
                    <?php echo form_open(base_url('veiculo/salvarSite'),array('role' => 'form', 'id' => 'formPadrao','class'=>'Formulario')); ?>
                    <div class="masked-input">
                        <input type="hidden" name="tipoMat" id="tipoMat" value="<?php echo $tipoMat;?>"/>
                        <div class="row clearfix">
                            <div class="col-xs-12 col-md-8 col-xl-8">
                                <div class="col-xs-12 col-md-6 col-xl-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type='text' class='form-control' id='nomeVeiculo' name='nomeVeiculo' maxlength="50" required/>
                                ...
                                <div class="col-xs-12 col-md-8 col-xl-8">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type='text' class='form-control' id='siteVeiculo' name='siteVeiculo'/>
                                            <label id="label-for" class="form-label">Home Page <span style="color:red">*</span></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-4 col-xl-4">
                                            ...
                                            <select class="form-control show-tick" name="grupo" id="grupo" data-live-search="true" data-size="6">
                                                ...
                                                <?php if (!empty($lista_grupo)) {
                                                    foreach ($lista_grupo as $item): ?>
                                                        <option
                                                            value="<?php echo $item['SEQ_GRUPO_VEICULO'] ?>" ><?php echo $item['DESC_GRUPO_VEICULO']; ?></option>
                                                    <?php endforeach;
                                                } ?>
                                            </select>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12 col-xl-12">
                            <a href="<?php echo base_url('veiculo/consultas') ?>" class="btn bg-red btn-circle-lg waves-effect waves-circle waves-float" data-toggle="tooltip" data-placement="top" title="Cancelar">
...
//        }, 'URL Inválida!');
        $('#formPadrao').validate({
            rules: {
                ...
                'siteVeiculo': {
                    ...
                    remote: {
                        ...
                        type: "POST",
                        url: '/monitor/veiculo/existeSite',
            ...
            messages:{
                'siteVeiculo': {
                    url: 'Link do Site é inválido!',
                    required: 'Link do Site é Obrigatório',
                    remote:'Link já cadastrado em outro Site!',
                },
                'nomeVeiculo': {
                    required: 'Nome do Site é obrigatóriio!'
                },
                'grupo': {
                    required: 'Grupo de Monitoramento é obrigatóriio!'
                },
