<div class="block-header inline">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ol class="breadcrumb breadcrumb-bg- align-right">
            ...
            <li><a href="<?php echo base_url('veiculo') ?>" class="ajax-link-interno">
    ...
    <div class="card">
        <div class="header">
            <div class="row clearfix">
                ...
                <div class="body">
                    <?php echo form_open(base_url('veiculo/salvar'),array('role' => 'form', 'id' => 'formPadrao','class'=>'Formulario')); ?>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-xs-12 col-md-8 col-xl-8">
                                ...
                                <div class="col-xs-12 col-md-6 col-xl-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type='text' class='form-control' id='fantasiaVeiculo' name='fantasiaVeiculo' maxlength="50"/>
                                ...
                                <div class="col-xs-12 col-md-6 col-xl-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type='text' class='form-control input-qtd cnpj-mask' id='cnpjVeiculo' name='cnpjVeiculo'/>
                                ...
                                <div class="col-xs-12 col-md-6 col-xl-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type='text' class='form-control email-mask' id='emailVeiculo' name='emailVeiculo' required/>
                                ...
                                <div class="col-xs-12 col-md-6 col-xl-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type='text' class='form-control phone-mask' maxlength="15" id='foneVeiculo' name='foneVeiculo' required/>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12 col-xl-12">
                            ...
                            <a href="<?php echo base_url('veiculo/consultai') ?>" class="btn bg-red btn-circle-lg waves-effect waves-circle waves-float" data-toggle="tooltip" data-placement="top" title="Cancelar">
