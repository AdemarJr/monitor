    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ol class="breadcrumb breadcrumb-bg- align-right">
            ...
            <li><a href="<?php echo base_url('veiculo/consultas') ?>" class="ajax-link-interno">
                    <i class="material-icons">fiber_new</i>Televis&atilde;o</a></li>
        ...
        <div class="header">
            <div class="row clearfix">
                <div class="col-xs-12 col-md-8 col-xl-8">
                    <h3 class="box-title">Dados da Televis&atilde;o</h3>
                </div>
                <div class="col-xs-12 col-md-4 col-xl-4">
                    <div class="image align-right">
                        <img id="avatar-prev" src="<?php echo base_url('assets/images/no-image.png');?>" width="48" height="48">
                    </div>
                </div>
            </div>
        </div><!-- /.box-header -->
                <div class="body">
                    <?php echo form_open(base_url('veiculo/salvarTv'),array('role' => 'form', 'id' => 'formPadrao','class'=>'Formulario')); ?>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#formPadrao').validate({
            ...
            messages:{
                'nomeVeiculo': {
                    required: 'Nome da Televis&atilde;o é obrigatório!'
                },
