 ...
 * Time: 10:05 AM
 */
//namespace Template\Docx;

include_once APPPATH."/third_party/template/Exceptions/RepeatRowException.php";
include_once APPPATH."/third_party/template/Docx/KeyNode.php";
include_once APPPATH."/third_party/template/Exceptions/RepeatParagraphException.php";
include_once APPPATH."/third_party/template/Exceptions/RepeatListException.php";
include_once APPPATH."/third_party/template/Numbers/Words.php";
//use Template\Exceptions\RepeatRowException;
//use Template\Docx\KeyNode;
//use Template\Exceptions\RepeatParagraphException;
//use Template\Exceptions\RepeatListException;
...
//        $this->workingDir = APPPATH.'/third_party/template/modelo/processado/docxDocxTemplating';
        ...
        if($download == false){
            ...
            header('Content-Disposition: attachment; filename="'.basename($outputPath).'"',true);
